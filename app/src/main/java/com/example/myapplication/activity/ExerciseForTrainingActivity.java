...
public class ExerciseForTrainingActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_exercise_for_training);

        editText=(EditText)findViewById(R.id.txtsearch2);
        ...
        AdapterView.OnItemClickListener itemListener = new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View v, int position, long id) {
                ...
                Intent intent = new Intent(ExerciseForTrainingActivity.this, TrainingActivity.class);
    ...
    private void setInitialData(){
       ...
       names.clear();
        ...
        exercisesList = (ListView) findViewById(R.id.exercisesForTrainingList);
        // создаем адаптер
